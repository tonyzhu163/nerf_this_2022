...
def render_rays(ray_batch,
    ...
    # perturb each ray is sampled at stratified
    ...
    if N_importance > 0:
        ...
        # Data gets stored twice independently
...
# THIS FUNCTION IS IN CREATE NERF
# get Embedder -> embed_fn/ embed_fn with direction (use_view_dirs = True)
# net chunk = number of points at a time (!= chunk)
# maybe we dont need this, just use run_network
